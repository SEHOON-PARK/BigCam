...
<select name="sType">
	<option value="sLocplc" <%=sType.equals("sLocplc")?"selected":""%>>지역명</option>
	<option value="sCntntsSj" <%=sType.equals("sCntntsSj")?"selected":""%>>제목명</option>
	<option value="sThema" <%=sType.equals("sThema")?"selected":""%>>주제명</option>
</select>
...
<%
	...
	NodeList adstrdNames = null;
	NodeList locplcs = null;
	NodeList themas = null;
	...
	adstrdNames = doc.getElementsByTagName("adstrdName");
	locplcs = doc.getElementsByTagName("locplc");
	themas = doc.getElementsByTagName("thema");
...
%>
		<tr>
			...
			<td align="center"><a href="#none" onclick="javascript:;move('<%=cntntsNo%>');">[<%=adstrdName%>]<%=cntntsSj%></a></td>
