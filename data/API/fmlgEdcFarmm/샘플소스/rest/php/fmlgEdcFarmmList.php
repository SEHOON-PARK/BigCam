...
<select name="sType">
	<option value="sLocplc" <?PHP if(isset($_REQUEST["sType"])){ if($_REQUEST["sType"]=="sLocplc") echo "selected"; }?>>지역명</option>
	<option value="sCntntsSj" <?PHP if(isset($_REQUEST["sType"])){ if($_REQUEST["sType"]=="sCntntsSj") echo "selected"; }?>>제목명</option>
	<option value="sThema" <?PHP if(isset($_REQUEST["sType"])){ if($_REQUEST["sType"]=="sThema") echo "selected"; }?>>주제명</option>
</select>
