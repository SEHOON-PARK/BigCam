...
<select name="sType">
	<option value="sCntntsSj" <?PHP if(isset($_REQUEST["sType"])){ if($_REQUEST["sType"]=="sCntntsSj") echo "selected"; }?>>명칭</option>
	<option value="sBneNm" <?PHP if(isset($_REQUEST["sType"])){ if($_REQUEST["sType"]=="sBneNm") echo "selected"; }?>>학명</option>
	<option value="sHbdcNm" <?PHP if(isset($_REQUEST["sType"])){ if($_REQUEST["sType"]=="sHbdcNm") echo "selected"; }?>>생약명</option>
</select>
