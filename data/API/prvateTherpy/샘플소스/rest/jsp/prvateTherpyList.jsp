...
<select name="sType">
	...
	<option value="sBneNm" <%=sType.equals("sBneNm")?"selected":""%>>학명</option>
	<option value="sHbdcNm" <%=sType.equals("sHbdcNm")?"selected":""%>>생약명</option>
</select>
...
<%
	...
	//오퍼레이션 명
	String operationName="prvateTherpyList";
	...
	NodeList bneNms = null;
	NodeList hbdcNms = null;
	...
	hbdcNms = doc.getElementsByTagName("hbdcNm");
...
<%
		for(int i=0; i<size; i++){
			...
			//생약명
			String hbdcNm = hbdcNms.item(i).getFirstChild() == null ? "" : hbdcNms.item(i).getFirstChild().getNodeValue();
			//썸네일 이미지
