	...
	<tr>
		<td width="85%">
			과명&nbsp;<select name="fmlNm">
				...
				<option value="유시아강-내시류" <?PHP if(isset($_REQUEST["fmlNm"])){ if($_REQUEST["fmlNm"]=="유시아강-내시류") echo "selected"; }?>>유시아강-내시류</option>
				<option value="유시아강-고시류" <?PHP if(isset($_REQUEST["fmlNm"])){ if($_REQUEST["fmlNm"]=="유시아강-고시류") echo "selected"; }?>>유시아강-고시류</option>
				<option value="유시아강-외시류" <?PHP if(isset($_REQUEST["fmlNm"])){ if($_REQUEST["fmlNm"]=="유시아강-외시류") echo "selected"; }?>>유시아강-외시류</option>
				<option value="무시아강" <?PHP if(isset($_REQUEST["fmlNm"])){ if($_REQUEST["fmlNm"]=="무시아강") echo "selected"; }?>>무시아강</option>
			</select>&nbsp;&nbsp;&nbsp;&nbsp;
...
?>
<br>
<div style="TEXT-ALIGN: right"><input type="button" onclick="javascript:location.href='searchInsectFmNm.php'" value="초기화면"/></div>
</body>
</html>