...
function fncSearch(){
	with(document.searchApiForm){
		method="get";
		action = "searchMicroorganismFmNm.jsp";
		target = "_self";
		submit();
	}
}
	...
	<tr>
		<td width="85%">
			과명&nbsp;<select name="fmlNm">
				...
				<option value="Bacteria" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("Bacteria")?"selected":""%>>Bacteria</option>
				<option value="Fungi" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("Fungi")?"selected":""%>>Fungi</option>
				<option value="Mushroom" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("Mushroom")?"selected":""%>>Mushroom</option>
				<option value="Yeast" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("Yeast")?"selected":""%>>Yeast</option>
			</select>&nbsp;&nbsp;&nbsp;&nbsp;
...
if(true){
	...
	String serviceAction="searchMicroorganism";
