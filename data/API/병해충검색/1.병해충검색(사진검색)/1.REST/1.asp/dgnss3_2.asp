...
'곤충상세조회의 서비스코드(상세한 내용은 Open API 이용안내 참조)
serviceCode = "SVC08"
...
%>
	...
	<%Else
		...
		Set wrongedCrop = xmlDOM.SelectNodes("//wrongedCrop")
		If Not wrongedCrop(0) Is Nothing Then wrongedCropText= wrongedCrop(0).Text Else wrongedCropText = "" End If

		Set shapeInfo = xmlDOM.SelectNodes("//shapeInfo")
		If Not shapeInfo(0) Is Nothing Then shapeInfoText= shapeInfo(0).Text Else shapeInfoText = "" End If

		Set quarantineInfo = xmlDOM.SelectNodes("//quarantineInfo")
		If Not quarantineInfo(0) Is Nothing Then quarantineInfoText= quarantineInfo(0).Text Else quarantineInfoText = "" End If
