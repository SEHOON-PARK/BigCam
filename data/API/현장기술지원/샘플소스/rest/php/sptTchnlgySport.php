...
<select name="searchtype">
	...
	<option value="3" <?PHP if(isset($_REQUEST["searchtype"])){ if($_REQUEST["searchtype"]=="3") echo "selected"; }?>>품목</option>
	<option value="4" <?PHP if(isset($_REQUEST["searchtype"])){ if($_REQUEST["searchtype"]=="4") echo "selected"; }?>>내용</option>
</select>
