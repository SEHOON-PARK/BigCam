...
<input type="hidden" name="pageNo">
	<table width="100%" cellSpacing="0" cellPadding="0">
		<tr>
		 상세 분류&nbsp;<select name="subCombo" id="subCombo" onchange="listMove();" > 
<%
...
%>
		...
		동영상 제목&nbsp;<input type="text" name="videoTitle" value="<%=request.getParameter("videoTitle")==null?"": new String(request.getParameter("videoTitle").getBytes("8859_1"), "UTF-8")%>">
		<td align="right">
