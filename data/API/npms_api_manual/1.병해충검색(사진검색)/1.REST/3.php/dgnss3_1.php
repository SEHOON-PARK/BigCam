...
<?
	...
	$serviceCode = "SVC07"; // 해충상세조회의 서비스코드(상세한 내용은 Open API 이용안내 참조)
...
<?	}else{
		...
		$damageInfo = $parser->document->damageinfo[0]->tagData;
		$preventMethod = $parser->document->preventmethod[0]->tagData;
?>
