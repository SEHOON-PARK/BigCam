...
<script type="text/javascript">
	...
	function fncFocus(fmlSeqNo){
		try{
		    document.getElementById('idx'+fmlSeqNo).focus();
		}catch(e){
	...
	function fncNextList(seq,cntCode){
		var popupUrl="onccpPoP.jsp?lvbNo="+seq+"&cntCode="+cntCode+"&check4=statInsect";
