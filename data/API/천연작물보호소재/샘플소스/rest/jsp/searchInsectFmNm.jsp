	...
	<tr>
		<td width="85%">
			과명&nbsp;<select name="fmlNm">
				...
				<option value="you_na" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("you_na")?"selected":""%>>유시아강-내시류</option>
				<option value="you_go" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("you_go")?"selected":""%>>유시아강-고시류</option>
				<option value="you_woi" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("you_woi")?"selected":""%>>유시아강-외시류</option>
				<option value="mu" <%=request.getParameter("fmlNm")!=null && request.getParameter("fmlNm").equals("mu")?"selected":""%>>무시아강</option>
			</select>&nbsp;&nbsp;&nbsp;&nbsp;
...
if(true){
	...
	String serviceAction="searchInsect";
	...
	if(request.getParameter("fmlNm")!=null&&!request.getParameter("fmlNm").equals("")){
		String fmlNm="";
		if(request.getParameter("fmlNm").equals("you_na")){
			fmlNm="유시아강-내시류";
		}else if(request.getParameter("fmlNm").equals("you_go")){
			fmlNm="유시아강-고시류";
		}else if(request.getParameter("fmlNm").equals("you_woi")){
			fmlNm="유시아강-외시류";
		}else if(request.getParameter("fmlNm").equals("mu")){
			fmlNm="무시아강";
		}
		
		parameter += "&fmlNm="+fmlNm;
	}
	//학명 검색
