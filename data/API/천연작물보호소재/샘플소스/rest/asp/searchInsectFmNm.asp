	...
	<tr>
		<td width="85%">
			과명&nbsp;<select name="fmlNm">
				...
				<option value="유시아강-내시류" <%If Request("fmlNm")="유시아강-내시류" Then Response.Write("selected") Else Response.Write("") End If%>>유시아강-내시류</option>
				<option value="유시아강-고시류" <%If Request("fmlNm")="유시아강-고시류" Then Response.Write("selected") Else Response.Write("") End If%>>유시아강-고시류</option>
				<option value="유시아강-외시류" <%If Request("fmlNm")="유시아강-외시류" Then Response.Write("selected") Else Response.Write("") End If%>>유시아강-외시류</option>
				<option value="무시아강" <%If Request("fmlNm")="무시아강" Then Response.Write("selected") Else Response.Write("") End If%>>무시아강</option>
			</select>&nbsp;&nbsp;&nbsp;&nbsp;
...
%>
<br>
<div style="TEXT-ALIGN: right"><input type="button" onclick="javascript:location.href='searchInsectFmNm.asp'" value="초기화면"/></div>
</body>
</html>